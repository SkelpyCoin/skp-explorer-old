    ...
    describe('GET /api/getPriceTicker', function() {
        it('should be ok', function(done) {
            getPriceTicker(function(err, res) {
                ...
                node.expect(res.body).to.have.deep.property('tickers.SKP.BTC').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.SKP.EUR').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.SKP.USD').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.SKP.CNY').to.be.a.number;
